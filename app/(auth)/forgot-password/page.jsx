                ...
                <Card className="border border-slate-700/60 bg-slate-800/80 backdrop-blur-2xl shadow-2xl rounded-2xl overflow-hidden p-1.5">
                    <CardHeader className="pt-8 pb-6 px-8 text-center border-b border-slate-700/50">
                        <div className="mx-auto w-14 h-14 bg-gradient-to-br from-blue-500/20 to-indigo-500/20 rounded-xl flex items-center justify-center mb-5 ring-1 ring-blue-500/30 shadow-[0_0_30px_rgba(59,130,246,0.15)] transform rotate-3">
                            <Mail className="w-7 h-7 text-blue-400 transform -rotate-3" />
                        </div>
                        <CardTitle className="text-2xl font-bold tracking-tight text-white mb-2">Forgot Password</CardTitle>
                        ...
                        {success ? (
                            <div className="space-y-6 text-center">
                                <div className="bg-emerald-500/10 border border-emerald-500/20 p-4 rounded-xl flex items-start gap-3 text-left">
                                    ...
                                    <p className="text-sm text-emerald-200 leading-relaxed">
                                        ...
                                        <br /><br />
                                        <span className="text-xs text-emerald-400/80 italic">(For development, check your terminal for the link!)</span>
                                    </p>
                                </div>
                                <div className="pt-2">
                                    <Link href="/sign-in">
                                        <Button variant="outline" className="w-full h-12 bg-transparent border-slate-600 text-slate-300 hover:bg-slate-700/50 hover:text-white rounded-xl transition-all font-medium">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="pt-4 space-y-3">
                                    ...
                                    <Link href="/sign-in" className="block w-full text-center">
